...
<html lang="en">
    ...
    <body>
        ...
        if (!empty($_POST)) {
            ...
            $sql = "insert into employeer (name,email_id,password,mobile_number,gender,address,update_datetime) values ( '$_POST[name]', '$_POST[email_id]', '$_POST[password]', '$_POST[mobile_number]','$_POST[gender]', '$_POST[address]','$update_datetime' )";
                    ...
                    <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                        <div class="user-account job-user-account">
                            ...
                            <ul class="nav nav-tabs text-center" role="tablist">
                                <li role="presentation" class="active"><a href="#find-job" aria-controls="find-job" role="tab" data-toggle="tab">Post A Job</a></li>
                            </ul>
